...
<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
  <div className="lg:w-1/3">
    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
      ...
      <Image src={car} width={49} alt="University image" />
      </div>
      <span className="self-center text-2xl font-semibold">Car Repair</span>
    </a>
  </div>
...
<div className="py-6 text-sm text-center dark:text-gray-400">© 2023 Car Company Co. All rights reserved.</div>
</footer>
  );
};
